					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="form-group col-md-12">
								...
								<input type="text"  maxlength="50" minlength="2" onkeypress="return soloLetras(event)" name="name" class="form-control input-md"  value="{{$secretarias->name}}"  required="">
							</div>
							...
							<div class="form-group col-md-6">
								<h4>Documento:</h4>
								<input type="text" maxlength="10" onkeypress="return solonumeros(event)" name="documento" class="form-control input-md"  value="{{$secretarias->documento}}"  required="">
							</div>

							<div class="form-group col-md-6">
								<h4>Telefono:</h4>
								<input type="text"  maxlength="10" minlength="7" onkeypress="return solonumeros(event)" name="telefono" class="form-control input-md"  value="{{$secretarias->telefono}}"  required="">
							</div>

							<div class="form-group col-md-6">
								<h4>Nueva Contraseña:</h4>
								<input type="text"   minlength="8"  name="passwordN" class="form-control input-md" value="">
